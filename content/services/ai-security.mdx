...
aiSecurityData:
  ...
  faqs:
    - question: "What's the difference between AI security and regular application security?"
      answer: "AI systems have unique attack vectors — prompt injection, jailbreaks, data leakage through model outputs, system prompt extraction — that traditional security testing doesn't cover. We specialize in these AI-specific risks."
