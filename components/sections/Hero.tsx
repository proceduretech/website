        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <Link
                href="/case-studies"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white bg-surface-elevated border border-border rounded-lg hover:border-accent-teal hover:bg-accent-teal/10 transition-all duration-200"
              >
                View Our Work
              </Link>
            </motion.div>
              ...
              <div className="bg-surface border border-border rounded-2xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-accent-teal/20 to-accent-teal/5 border-b border-border px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-text-primary">What We Build</h3>
                      <p className="text-xs text-text-muted">Production AI systems</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-surface-elevated rounded-lg border border-border">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-text-primary">LLM Applications</p>
                      <p className="text-xs text-text-muted">RAG, agents, chatbots</p>
                    </div>
                    <span className="px-2 py-0.5 text-xs font-medium text-accent-teal-light bg-accent-teal/10 rounded">Core</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-surface-elevated rounded-lg border border-border">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-text-primary">ML Infrastructure</p>
                      <p className="text-xs text-text-muted">Pipelines, training, deployment</p>
                    </div>
                    <span className="px-2 py-0.5 text-xs font-medium text-accent-blue-light bg-accent-blue/10 rounded">Scale</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-surface-elevated rounded-lg border border-border">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-text-primary">Full Product Build</p>
                      <p className="text-xs text-text-muted">End-to-end development</p>
                    </div>
                    <span className="px-2 py-0.5 text-xs font-medium text-accent-teal-light bg-accent-teal/10 rounded">Ship</span>
                  </div>
                </div>
                ...
                <div className="px-6 py-4 border-t border-border bg-surface-elevated/50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-accent-teal animate-pulse" />
                      <span className="text-xs text-text-muted">Shipping production code</span>
                    </div>
