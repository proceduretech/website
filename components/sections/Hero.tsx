    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 sm:px-8 max-w-5xl mx-auto">
        <motion.p
          ...
          className="text-xs sm:text-sm font-semibold tracking-widest text-blue-600 dark:text-blue-400 uppercase mb-4 sm:mb-6"
        >
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-7xl font-bold text-zinc-900 dark:text-white leading-tight tracking-tight"
        >
        ...
        <motion.p
          ...
          className="mt-6 sm:mt-8 text-base sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed"
        >
