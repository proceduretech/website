...
const services = [
  {
    ...
    tags: ["LLM Applications", "AI Agents", "RAG Systems", "Fine-tuning", "MLOps"],
  },
  {
    ...
    tags: ["React & Next.js", "Node.js & Python", "Mobile Apps", "API Development"],
  },
  {
    name: "AI Security",
    description:
    ...
    tags: ["Threat Protection", "Prompt Injection Defense", "Data Privacy", "Compliance"],
  },
  {
    name: "Cloud & DevOps",
    description:
    ...
    tags: ["AWS & GCP", "Kubernetes", "CI/CD Automation", "Infrastructure as Code"],
  },
  {
