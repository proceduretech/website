        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-text-primary leading-tight tracking-tight mb-6">
              Hire Senior AI Engineers Without the 6-Month Search
            </h1>

            <p className="text-lg text-text-secondary leading-relaxed mb-8 max-w-2xl">
              AI engineer staffing solves the hardest problem in enterprise AI:
              finding senior talent that actually exists. While your competitors
              spend months searching for unicorn candidates, you can hire senior
              AI engineers and have them contributing within days.
            </p>
