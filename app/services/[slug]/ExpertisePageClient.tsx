...
export default function ExpertisePageClient({
  ...
  return (
    <main className="min-h-screen">
      ...
      <div id={["nodejs", "nextjs", "angular"].includes(expertise.slug) ? "services" : undefined}>
        <CapabilitiesGrid
          title={expertise.slug === "dotnet" ? ".NET Development Services We Offer" : expertise.slug === "nextjs" ? "What We Build With Next.js" : expertise.slug === "nodejs" ? "Node.js Development Services" : expertise.slug === "angular" ? "Angular Development Services" : "Key Capabilities"}
          subtitle={expertise.slug === "dotnet" ? "End-to-end .NET services, from greenfield builds to legacy modernization." : expertise.slug === "nextjs" ? "From marketing sites to complex web applications, we deliver production-grade Next.js solutions." : expertise.slug === "nodejs" ? "APIs, microservices, real-time systems, and the backend your product runs on." : expertise.slug === "angular" ? "Full-stack applications, migrations, and performance work." : "Everything you need to build production-grade solutions"}
      ...
      {pageData.process && (
        <div id={["nodejs", "angular"].includes(expertise.slug) ? "process" : undefined}>
          <ProcessTimeline
            title={expertise.slug === "frontend-development" ? "Our Frontend Development Process" : expertise.slug === "backend-development" ? "Our Backend Development Process" : expertise.slug === "nextjs" ? "How We Deliver Next.js Projects" : expertise.slug === "nodejs" ? "How We Deliver Node.js Projects" : expertise.slug === "angular" ? "How We Deliver Angular Projects" : "Our Process"}
            subtitle={["nodejs", "angular"].includes(expertise.slug) ? "Working software every sprint, not just progress updates." : "A predictable process built for high-quality delivery"}
      ...
      {/* Mid-page CTA for dotnet/nextjs/nodejs/angular - before Architecture section */}
      {["dotnet", "nextjs", "nodejs", "angular"].includes(expertise.slug) && (
        <section id={expertise.slug === "angular" ? "discuss" : undefined} className="relative py-16 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-text-primary mb-6">
                Discuss Your <span className="text-highlight">{expertise.slug === "nextjs" ? "Next.js" : expertise.slug === "nodejs" ? "Node.js" : expertise.slug === "angular" ? "Angular" : ".NET"} Project</span>
              </h2>
      ...
      {pageData.engagementModels && (
        <div id={["nodejs", "nextjs", "angular"].includes(expertise.slug) ? "hire" : undefined}>
          ...
          {/* Angular: "What you get" block before EngagementModels */}
          {expertise.slug === "angular" && (
            <div className="bg-surface pt-12 sm:pt-16">
              <div className="max-w-5xl mx-auto px-4 sm:px-6">
                <motion.div
                ...
                >
                  <p className="text-text-secondary leading-relaxed mb-6">
                    Need Angular developers to join your existing team? We provide engineers who integrate with your workflows, sprint cadence, and tooling. Our developers have worked with Angular since version 2 and ship production code from the first sprint.
                  </p>
                  <ul className="space-y-3 mb-8">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3 text-sm text-text-secondary">
                        <svg className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
                        </svg>
                        {item}
                      </li>
          ...
          {/* Node.js/Angular: Pricing line + CTA after EngagementModels */}
          {["nodejs", "angular"].includes(expertise.slug) && (
              ...
              <div className="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                >
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-8 py-3 rounded-lg bg-cta text-cta-text font-semibold hover:brightness-110 transition-all"
                  >
                    {expertise.slug === "nodejs" ? "Talk to Us About Your Team" : "Discuss Your Team Needs"}
                    <svg className="w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
                  </a>
      ...
      {pageData.faqs.length > 0 && (
        <div id={["nodejs", "angular"].includes(expertise.slug) ? "faq" : undefined}>
          <FAQSection
            title={expertise.slug === "dotnet" ? ".NET Development Services FAQ" : expertise.slug === "nextjs" ? "Next.js Development FAQ" : expertise.slug === "nodejs" ? "Node.js Development FAQ" : expertise.slug === "angular" ? "Angular Development FAQ" : undefined}
            faqs={pageData.faqs}
          />
        </div>
      )}
