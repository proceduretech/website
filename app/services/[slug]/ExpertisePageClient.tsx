...
export default function ExpertisePageClient({
  ...
  return (
    <main className="min-h-screen">
      ...
      {pageData.process && (
        <div id={["nodejs", "react", "python", "flutter"].includes(expertise.slug) ? "process" : undefined}>
          <ProcessTimeline
            title={expertise.slug === "frontend-development" ? "Our Frontend Development Process" : expertise.slug === "backend-development" ? "Our Backend Development Process" : expertise.slug === "nextjs" ? "How We Deliver Next.js Projects" : expertise.slug === "nodejs" ? "How We Deliver Node.js Projects" : expertise.slug === "react" ? "How We Deliver React Projects" : expertise.slug === "python" ? "How We Deliver Python Projects" : expertise.slug === "flutter" ? "From Concept to App Store" : "Our Process"}
      ...
      {/* Mid-page CTA for dotnet/nextjs/nodejs/react/python/flutter - before Architecture section */}
      {["dotnet", "nextjs", "nodejs", "react", "python", "flutter"].includes(expertise.slug) && (
        <section id={["react", "python", "flutter"].includes(expertise.slug) ? "discuss" : undefined} className="relative py-16 sm:py-24 bg-surface">
      ...
      {pageData.engagementModels && (
        <div id={["nodejs", "nextjs", "react", "python", "flutter"].includes(expertise.slug) ? "hire" : undefined}>
          ...
          {/* Node.js / React / Python / Flutter: Pricing line + CTA after EngagementModels */}
          {["nodejs", "react", "python", "flutter"].includes(expertise.slug) && (
      ...
      {pageData.faqs.length > 0 && (
        <div id={["nodejs", "react", "python", "flutter"].includes(expertise.slug) ? "faq" : undefined}>
          <FAQSection
            title={expertise.slug === "dotnet" ? ".NET Development Services FAQ" : expertise.slug === "nextjs" ? "Next.js Development FAQ" : expertise.slug === "nodejs" ? "Node.js Development FAQ" : expertise.slug === "react" ? "React Development FAQ" : expertise.slug === "python" ? "Python Development FAQ" : expertise.slug === "flutter" ? "Flutter App Development FAQ" : undefined}
            faqs={pageData.faqs}
          />
        </div>
      )}
