...
export default function ExpertisePageClient({
  ...
  return (
    <main className="min-h-screen">
      ...
      {pageData.process && (
        <div id={["nodejs", "react"].includes(expertise.slug) ? "process" : undefined}>
          <ProcessTimeline
            title={expertise.slug === "frontend-development" ? "Our Frontend Development Process" : expertise.slug === "backend-development" ? "Our Backend Development Process" : expertise.slug === "nextjs" ? "How We Deliver Next.js Projects" : expertise.slug === "nodejs" ? "How We Deliver Node.js Projects" : expertise.slug === "react" ? "How We Deliver React Projects" : "Our Process"}
            subtitle={expertise.slug === "nodejs" ? "Working software every sprint, not just progress updates." : expertise.slug === "react" ? "Working software every sprint, not just progress updates." : "A predictable process built for high-quality delivery"}
      ...
      {/* Mid-page CTA for dotnet/nextjs/nodejs/react - before Architecture section */}
      {["dotnet", "nextjs", "nodejs", "react"].includes(expertise.slug) && (
        <section id={expertise.slug === "react" ? "discuss" : undefined} className="relative py-16 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-text-primary mb-6">
                Discuss Your <span className="text-highlight">{expertise.slug === "nextjs" ? "Next.js" : expertise.slug === "nodejs" ? "Node.js" : expertise.slug === "react" ? "React" : ".NET"} Project</span>
              </h2>
      ...
      {pageData.engagementModels && (
        <div id={["nodejs", "nextjs", "react"].includes(expertise.slug) ? "hire" : undefined}>
          ...
          {/* Node.js / React: Pricing line + CTA after EngagementModels */}
          {["nodejs", "react"].includes(expertise.slug) && (
      ...
      {pageData.faqs.length > 0 && (
        <div id={["nodejs", "react"].includes(expertise.slug) ? "faq" : undefined}>
          <FAQSection
            title={expertise.slug === "dotnet" ? ".NET Development Services FAQ" : expertise.slug === "nextjs" ? "Next.js Development FAQ" : expertise.slug === "nodejs" ? "Node.js Development FAQ" : expertise.slug === "react" ? "React Development FAQ" : undefined}
            faqs={pageData.faqs}
          />
        </div>
      )}
