...
export default function ExpertisePageClient({
  ...
  return (
    <main className="min-h-screen">
      ...
      <div id={["nodejs", "nextjs", "python"].includes(expertise.slug) ? "services" : undefined}>
        <CapabilitiesGrid
          title={expertise.slug === "dotnet" ? ".NET Development Services We Offer" : expertise.slug === "nextjs" ? "What We Build With Next.js" : expertise.slug === "nodejs" ? "Node.js Development Services" : expertise.slug === "python" ? "Python Development Services" : "Key Capabilities"}
          subtitle={expertise.slug === "dotnet" ? "End-to-end .NET services, from greenfield builds to legacy modernization." : expertise.slug === "nextjs" ? "From marketing sites to complex web applications, we deliver production-grade Next.js solutions." : expertise.slug === "nodejs" ? "APIs, microservices, real-time systems, and the backend your product runs on." : expertise.slug === "python" ? "Backend systems, AI/ML, and the data infrastructure your product depends on." : "Everything you need to build production-grade solutions"}
      ...
      {pageData.process && (
        <div id={["nodejs", "python"].includes(expertise.slug) ? "process" : undefined}>
          <ProcessTimeline
            title={expertise.slug === "frontend-development" ? "Our Frontend Development Process" : expertise.slug === "backend-development" ? "Our Backend Development Process" : expertise.slug === "nextjs" ? "How We Deliver Next.js Projects" : expertise.slug === "nodejs" ? "How We Deliver Node.js Projects" : expertise.slug === "python" ? "How We Deliver Python Projects" : "Our Process"}
            subtitle={expertise.slug === "nodejs" ? "Working software every sprint, not just progress updates." : expertise.slug === "python" ? "Working software every sprint, not just progress updates." : "A predictable process built for high-quality delivery"}
      ...
      {/* Mid-page CTA for dotnet/nextjs/nodejs/python - before Architecture section */}
      {["dotnet", "nextjs", "nodejs", "python"].includes(expertise.slug) && (
        <section id={expertise.slug === "python" ? "discuss" : undefined} className="relative py-16 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-text-primary mb-6">
                Discuss Your <span className="text-highlight">{expertise.slug === "nextjs" ? "Next.js" : expertise.slug === "nodejs" ? "Node.js" : expertise.slug === "python" ? "Python" : ".NET"} Project</span>
              </h2>
      ...
      {pageData.engagementModels && (
        <div id={["nodejs", "nextjs", "python"].includes(expertise.slug) ? "hire" : undefined}>
          ...
          {/* Node.js / Python: Pricing line + CTA after EngagementModels */}
          {["nodejs", "python"].includes(expertise.slug) && (
      ...
      {pageData.faqs.length > 0 && (
        <div id={["nodejs", "python"].includes(expertise.slug) ? "faq" : undefined}>
          <FAQSection
            title={expertise.slug === "dotnet" ? ".NET Development Services FAQ" : expertise.slug === "nextjs" ? "Next.js Development FAQ" : expertise.slug === "nodejs" ? "Node.js Development FAQ" : expertise.slug === "python" ? "Python Development FAQ" : undefined}
            faqs={pageData.faqs}
          />
        </div>
      )}
