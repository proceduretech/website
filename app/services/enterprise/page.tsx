        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-text-primary leading-tight tracking-tight mb-6">
              Enterprise AI That Passes Security Review on the First Try
            </h1>

            <p className="text-lg text-text-secondary leading-relaxed mb-8 max-w-2xl">
              Enterprise AI development built for your compliance requirements,
              security standards, and procurement processes. Senior engineers
              who have shipped in regulated industries and understand that
              enterprise-grade means audit-ready, not just functional.
            </p>
