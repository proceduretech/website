...
const benefits = [
  {
    ...
    description: "Work from anywhere with a globally distributed team spanning 4 continents. Async-first communication means no mandatory meetings disrupting your focus time.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Above-market salaries benchmarked against top tech companies, plus equity participation. We invest in talent that delivers enterprise-grade results.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Annual stipend for courses, conferences, and certifications. Stay current with AI advancements and earn credentials that accelerate your career trajectory.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Full medical, dental, and vision insurance for you and your dependents. Plus a dedicated wellness stipend for gym memberships, mental health support, or whatever keeps you performing at your best.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Flexible time off with a minimum of 4 weeks encouraged annually. Sustainable performance requires genuine rest, and we trust senior professionals to manage their own schedules.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Solve complex AI challenges for industry-leading clients. Direct access to cutting-edge models from OpenAI, Anthropic, and Google, plus the latest MLOps tooling and infrastructure.",
  },
];
...
const values = [
  {
    ...
    description: "Every system we build is designed for enterprise-scale production. Our engineers take pride in delivering AI solutions that handle millions of requests and meet the strictest SLAs.",
  },
  {
    title: "Continuous Technical Growth",
    description: "AI evolves rapidly, and so do we. Weekly knowledge sharing, dedicated learning time, and a culture of experimentation ensure you stay at the forefront of the industry.",
  },
  {
    title: "Direct, Transparent Communication",
    description: "We value candid feedback, thoughtful debate, and clear expectations. No politics or ambiguity, just honest collaboration focused on delivering exceptional results for our clients.",
  },
  {
    title: "Ownership and Accountability",
    description: "Senior engineers own their projects end-to-end. You will have the autonomy to make architectural decisions and the responsibility to deliver outcomes that drive real business impact.",
  },
];
  ...
  return (
    <main className="relative min-h-screen bg-base overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 sm:pb-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Build production AI systems for Fortune 500 companies and high-growth startups. We offer remote ML engineer and AI developer positions with top-tier compensation, meaningful work, and a culture built for senior technical talent.
            </motion.p>
            ...
            >
              <a
                href="#openings"
                className="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-white bg-gradient-to-r from-accent-teal to-accent-blue rounded-xl hover:from-accent-teal-light hover:to-accent-blue-light transition-all duration-200 shadow-lg shadow-accent-teal/20"
              >
                Explore AI Engineering Roles
      ...
      <section className="relative py-20 sm:py-28 bg-base">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              A high-performance culture built on trust, technical excellence, and a shared commitment to delivering production AI systems that transform enterprises.
            </p>
          </motion.div>
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section id="openings" className="relative py-20 sm:py-28 bg-surface scroll-mt-24">
        {/* Hexagon pattern */}
        <div
          className="absolute inset-0 opacity-[0.02]"
          style={{
                    ...
                    <div className="px-6 sm:px-8 pb-8 pt-0">
                      <div className="border-t border-border pt-6">
                            ...
                            <ul className="space-y-3">
                              {job.responsibilities.map((resp, i) => (
                                <li key={i} className="flex items-start gap-3 text-sm text-text-secondary">
                                  <svg className="w-5 h-5 text-accent-teal shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-accent-teal to-accent-blue rounded-xl hover:from-accent-teal-light hover:to-accent-blue-light transition-all duration-200 shadow-lg shadow-accent-teal/20"
                        >
                          Apply Now
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact?type=general-application"
